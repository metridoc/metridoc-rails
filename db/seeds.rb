...
Institution.create!(name: 'DARTMOUH', code: 'DARTMOUH', zip_code: '03755') if Institution.of_code('HARVARD').blank?
Institution.create!(name: 'MIT', code: 'MIT', zip_code: '02142') if Institution.of_code('HARVARD').blank?
