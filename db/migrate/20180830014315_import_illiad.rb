class ImportIlliad < ActiveRecord::Migration[5.2]
  def change
    create_table :ill_borrowings do |t|
    ...
    create_table :ill_fiscal_start_months do |t|
      t.integer :version , limit: 8, null: false
      t.integer :month , null: false
    end

    create_table :ill_groups do |t|
      t.integer :version , limit: 8, null: false
      t.string :group_name , limit: 255, null: false
      t.integer :group_no , null: false
    end

    create_table :ill_lender_groups do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_lender_infos do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_lendings do |t|
      t.integer :version , limit: 8, null: false
      t.string :request_type , limit: 255, null: false
    ...
    create_table :ill_lending_trackings do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_locations do |t|
      t.integer :version , limit: 8, null: false
      t.string :abbrev , limit: 255, null: false
      t.string :location , limit: 255, null: false
    end

    create_table :ill_reference_numbers do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_trackings do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_transactions do |t|
      t.integer :version , limit: 8, null: false
    ...
    create_table :ill_user_infos do |t|
      t.integer :version , limit: 8, null: false
