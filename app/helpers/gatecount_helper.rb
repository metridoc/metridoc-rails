  ...
  def time_table
      output_table=GateCount::CardSwipe.connection.select_all(
        "SELECT
           ...
           COUNT(DISTINCT card_num) AS num_people  
         FROM gate_count_card_swipes 
           AND door_name IN ('VAN PELT LIBRARY ADA DOOR_ *VPL', 'VAN PELT LIBRARY TURN1_ *VPL', 'VAN PELT LIBRARY TURN2_ *VPL', 'VAN PELT LIBRARY USC HANDICAP ENT VERIFY_ *VPL', 'FURNESS TURNSTILE_ *FUR', 'BIO LIBRARY TURNSTILE GATE_ *JSN')         GROUP BY 1, 2, 3;")
