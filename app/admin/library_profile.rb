ActiveAdmin.register_page "LibraryProfile" do
  menu if: proc{ authorized?(:read, "LibraryProfile") }, parent: I18n.t("active_admin.resource_sharing")

  content title: proc{ I18n.t("active_admin.library_profile.library_profile_menu") } do
